...
public class SensorRepository {
	...
	public static ArrayList<Sensor> selectAll() {
		ArrayList<Sensor> arr = new ArrayList<Sensor>();

		try {
			String QRY = "SELECT recordValues FROM sensors.sensorvalues LIMIT 5;";
	...
	public static ArrayList<Sensor> selectAll(String query) {
		ArrayList<Sensor> arr = new ArrayList<Sensor>();
